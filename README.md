# Sports
 https://indiansportsarchive.vercel.app/
...
If you want a short one-line description for the GitHub header instead, use:

A brutalist, animated web experience exploring the legacy of Indian sports using GSAP and modern CSS.
